...
function pages_pdf_converter_function()	{
		...
		function convertToPDF()	{
			...
			if(allVals == '')	{
				...
				jQuery.ajax({
					...
					data: '&task=processPDF&postype=pages&values='+allVals,
					beforeSend: function() {
					...
					success: function(response){
						...
						jQuery("#successmessage").html('<div class="updated">Page(s) successfully converted to PDF.</div>');
					}
				});
			}
		}
